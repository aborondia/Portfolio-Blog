...
const images = {
  post1: {
    img1: {
      ...
      alt: "A picture of me (Andrew)",
      caption: { text: `Yup, that's me.`, link: "" },
    },
    img2: {
...
const paragraphs = {
  ...
  post5: [
    <Container>
      {Paragraph(
        <>
          The remaster of the classic RPG <strong>Saga Frontier</strong> was
          just released a few weeks ago. In this guide I'm going to share with
          you various strategies I've learned to master the game. These
          strategies apply to both the original 1997 version, as well as the new
          remaster.
        </>
      )}
      ...
      <ul>
        <li>
          Learns every single spell in the game, including opposing schools, and
          some unique to him.
        </li>
      ...
      <ul>
        <li>
          ...
          magic, which is one of the most powerful schools of magic in the game.
        </li>
        ...
        <li>
          ...
          . <br />
          <em>
            You can use the Stasis Rune spell instead of snake oil to obtain the
            effect. Although very well known, and referred to as a glitch, it
            was not removed from the remaster.
          </em>
        </li>
      </ul>
      ...
      <ul>
        <li>
          Has the advantage over other mystics of not having mystic mail locked
          to their equipment slots.
        </li>
        <li>
      ...
      {Paragraph(
        <>
          ...
          <ul>
            <li>
              Use skills that a character has a talent for to raise
              corresponding stats; sword/fist increases strength &amp; WP, magic
              increases will &amp; JP, guns increase will &amp; WP.
            </li>
            <li>
            ...
            <li>
              Some enemies become unavailable later in the game so the earlier
              you start absorbing monsters with your own monster character, the
              higher their HP potential is.
            </li>
            <li>
              Once you obtain one rune (rune magic), or card (arcane magic), any
              character not present <strong>will never be able to</strong>{" "}
              obtain the corresponding gift, even if recruited before completing
              the quest.
            </li>
            <li>
              ...
              particular school in your party at the time you do the
              corresponding quest, and that they do not possess any magic from
              opposing schools.
            </li>
            <li>
      ...
      {Paragraph(
        <>
          <p>
            ...
            you plan the quests to obtain the corresponding magic school gifts
            you want them to learn, keeping in mind that (with the exception of
            Blue/Rouge){" "}
            <strong>
          ...
          <p>
            If you are using a monster, plan which form and skills you want by
            end game and be constantly alert for enemies that will yield the
            correct skills. Some enemies will be hard/impossible to find once
            you progress too far in the game. Refer to{" "}
          ...
          <p>
            ...
            powerful gear you can. The Merchants in Koorong sell the most
            powerful equipment that can be purchased.
          </p>
        </>
      )}
      ...
      {Paragraph(
        <>
          <p>
            ...
            <a href="https://saga.fandom.com/wiki/Gold_Ingot_Trick">
              this guide
            </a>
          ...
          <ol>
            ...
            <li>
              ...
              and if the selling price is not greater than 500G, you must buy
              more ingots from the Nelson merchant.
            </li>
            <li>
              Sell your ingots in Koorong until the price drops below 500G.
            </li>
            <li>
      ...
      {Paragraph(
        <>
          <p>
            Some of the most powerful enemies in the game, including some
            bosses, are susceptible to instant death/petrify skills. Some are
            more effective than others:
          </p>
          <ul>
            <li>
              Time Eclipse - The most effective petrification ability in the
              game. Can be learned by any human/mystic if your protagonist has
              access to Time Lord's castle. If playing as Blue/Rouge, only he
              can learn time magic, not his comrades.
            </li>
            <li>
              Death Touch - Extremely potent and will almost always kill an
              enemy that is not immune to death. Can be learned by any monster
              character.
            </li>
            <li>
            ...
            <li>
              Dead End - An instant death sword skill that is less effective
              than the other skills listed, but is generally easier to obtain
              and is useful to human characters that do not use magic.
            </li>
          </ul>
        </>
      )}
      ...
      {Paragraph(
        <>
          <p>
            ...
            health (damaged by about 700+ HP) they will attempt to possess one
            of your party members. If the character is human, it will cause an
            unequippable sword called "Glirandly" to be added to their
            equipment. For each sword the human is equipped with it will raise
            all stats by 10. This can add up to a massive boost to their stats.
          ...
          <p>
            So you learned how to pick the best characters, how to build them,
            and all the important information you need to make the ultimate
            team. Now you are ready to confidently conquer the world of Saga
            Frontier.
          </p>
        </>
      )}
